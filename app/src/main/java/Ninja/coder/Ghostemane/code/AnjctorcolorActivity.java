...
import Ninja.coder.Ghostemane.code.component.FastScrollCompat.*;

public class AnjctorcolorActivity extends BaseCompat {
    ...
    imageview29.setOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View _view) {
            ...
            ViewGroup v =
                (ViewGroup)
                    ((ViewGroup) AnjctorcolorActivity.this.findViewById(android.R.id.content))
                        .getChildAt(0);
  ...
  public void _setcolor(final View _setlinear, final TextView _tvone) {
    ...
    ColorPickerDialogBuilder.with(AnjctorcolorActivity.this)
        .setTitle("SetColor")
