...
public class ApplicationLoader extends Application {
    ...
    public void onCreate() {
        ...
        try (SassCompiler compiler = AndroidSassCompilerFactory.bundled(this)) {
            Toast.makeText(getApplicationContext(), compiler.getVersion().toString(), Toast.LENGTH_SHORT).show();
        } catch (Exception err) {
            err.printStackTrace();
        }
        ...
        try {
            ...
            Toast.makeText(getApplicationContext(), "Welcom to Ghost web ide " + v, Toast.LENGTH_SHORT).show();
