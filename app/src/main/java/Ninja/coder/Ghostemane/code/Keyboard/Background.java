...
public class Background extends BaseCompat {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    rang3.getButtonDrawable().setColorFilter(MaterialColors.getColor(rang3,ColorAndroid12.TvColor), PorterDuff.Mode.SRC_IN);
    rang4.getButtonDrawable().setColorFilter(MaterialColors.getColor(rang4,ColorAndroid12.TvColor), PorterDuff.Mode.SRC_IN);
    rang5.getButtonDrawable().setColorFilter(MaterialColors.getColor(rang5,ColorAndroid12.TvColor), PorterDuff.Mode.SRC_IN);
    rang6.getButtonDrawable().setColorFilter(MaterialColors.getColor(rang6,ColorAndroid12.TvColor), PorterDuff.Mode.SRC_IN);
    rang7.getButtonDrawable().setColorFilter(MaterialColors.getColor(rang7,ColorAndroid12.TvColor), PorterDuff.Mode.SRC_IN);
    rang8.getButtonDrawable().setColorFilter(MaterialColors.getColor(rang8,ColorAndroid12.TvColor), PorterDuff.Mode.SRC_IN);
    rang9.getButtonDrawable().setColorFilter(MaterialColors.getColor(rang9,ColorAndroid12.TvColor), PorterDuff.Mode.SRC_IN);
    rang10
        .getButtonDrawable()
        .setColorFilter(MaterialColors.getColor(rang10,ColorAndroid12.TvColor), PorterDuff.Mode.SRC_IN);
