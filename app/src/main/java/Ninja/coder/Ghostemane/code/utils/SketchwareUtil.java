...
public class SketchwareUtil {
    ...
    public static void sortListMap(
        ...
        Collections.sort(
                ...
                new Comparator<HashMap<String, Object>>() {
                    public int compare(
                            HashMap<String, Object> _compareMap1, HashMap<String, Object> _compareMap2) {
                        if (isNumber) {
    ...
    public static void CropImage(Activity _activity, String _path, int _requestCode) {
        try {
            ...
            Toast.makeText(_activity, "Your device doesn't support the crop action!", Toast.LENGTH_SHORT)
                    .show();
        }
    }
    ...
    public static float getDip(Context _context, int _input) {
        return TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP, _input, _context.getResources().getDisplayMetrics());
    }
