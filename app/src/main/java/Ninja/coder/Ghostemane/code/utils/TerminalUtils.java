...
public class TerminalUtils {
    ...
    public static void RunPythonCode(TerminalView terminal, Context context, String code) {
        ...
        String line = Commands.getInterpreterCommand(context, code);
    ...
    public static void RunPhp(TerminalView terminal, Context context, String code) {
        String shell = "/bin/sh";
        if (!new File("/bin/sh").exists()) {
            shell = "/system/bin/sh";
        }
        ...
        terminal.post(
                () -> {
                    terminal.mTermSession.write(
                            php.runOffline(ApplicationLoader.getContext(), new File(code)));
                });
