...
public class SetThemeForJson {
	...
	public SetThemeForJson setThemeCodeEditor(CodeEditor editor, HashMap<String, Object> imap, boolean chackHashMap,Activity x) {
		...
		if (imap.containsKey("LINE_DIVIDER")) {
			...
			editor.getColorScheme().setColor(EditorColorScheme.LINE_DIVIDER, Color.parseColor("#FF2B2121"));
		...
		if (imap.containsKey("AUTO_COMP_PANEL_BG")) {
			...
			editor.getColorScheme().setColor(EditorColorScheme.AUTO_COMP_PANEL_BG, Color.parseColor("#FF281B26"));
		...
		if (imap.containsKey("AUTO_COMP_PANEL_CORNER")) {
			...
			editor.getColorScheme().setColor(EditorColorScheme.AUTO_COMP_PANEL_CORNER, Color.parseColor("#FFFCACF1"));
		...
		if (imap.containsKey("LINE_NUMBER_BACKGROUND")) {
			...
			editor.getColorScheme().setColor(EditorColorScheme.LINE_NUMBER_BACKGROUND, Color.parseColor("#FF281B26"));
		...
		if (imap.containsKey("WHOLE_BACKGROUND")) {
			...
			editor.getColorScheme().setColor(EditorColorScheme.WHOLE_BACKGROUND, Color.parseColor("#FF281B26"));
	...
	public SetThemeForJson addTextColor(TextView id, String datatype, int color, Activity x,
	HashMap<String, Object> imap2) {
	...
	public SetThemeForJson addImageColor(ImageView id, Activity c, String datatype, HashMap<String, Object> map,
	int color) {
	...
	public SetThemeForJson mfabcolor(Activity c, ExtendedFloatingActionButton fab, HashMap<String, Object> map) {
		if (map.containsKey("FabColorStroker") && map.containsKey("FabImageColor")) {
			fab.setStrokeColor(ColorStateList.valueOf(Color.parseColor(map.get("FabColorStroker").toString())));
			fab.setStrokeWidth(1);
			fab.setIconTint(ColorStateList.valueOf(Color.parseColor(map.get("FabImageColor").toString())));
		} else {
	...
	public SetThemeForJson mfab2(Activity c, ExtendedFloatingActionButton fab, HashMap<String, Object> imap) {
