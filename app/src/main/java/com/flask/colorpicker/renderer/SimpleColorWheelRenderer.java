    ...
    public void draw() {
        ...
        for (int i = 0; i < density; i++) {
            ...
            for (int j = 0; j < total; j++) {
                ...
                colorWheelRenderOption.targetCanvas.drawCircle(
                        x, y, size - colorWheelRenderOption.strokeWidth, selectorFill);

                if (currentCount >= setSize) colorCircleList.add(new ColorCircle(x, y, hsv));
