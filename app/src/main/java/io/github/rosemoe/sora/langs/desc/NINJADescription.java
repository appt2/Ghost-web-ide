...
public class NINJADescription implements LanguageDescription {
    ...
    public String[] getKeywords() {
        ...
        return new String[]{"absolute", "abstract", "all", "and", "and_then", "array", "as", "asm", "attribute", "begin", "bindable", "case", "class",
                ...
                "then", "to", "try", "type", "unit", "until", "uses", "value", "var", "view", "virtual", "while", "with", "xor", "identifier", "msg", "praperty", "exec", "except", "baseException", "import", "from", "system", "printor", "out", "cin", "cout", "lambda", "z", "qar", "var", "vel", "val", "synchronized", "int32", "int64", "extends", "sealed", "TypeView", "void", "permits"
        };
    }
