...
public class SwiftDescription implements LanguageDescription {
    ...
    public String[] getKeywords() {
        ...
        return new String[]{
                "case", "class", "continue", "default", "deinit", "didSet", "do", "dynamicType", "else", "enum", "extension", "fallthrough", "for", "func", "get", "if", "import", "in", "infix", "init", "inout", "is", "left", "let", "mutating", "new", "none", "nonmutating", "operator", "override", "postfix", "precedence", "prefix", "protocol", "return", "right", "safe", "Self", "self", "set", "struct", "subscript", "switch", "Type", "typealias", "unowned", "unsafe", "var", "weak", "where", "while", "willSet", "convenience", "dynamic", "final", "infix", "lazy", "mutating", "nonmutating", "optional", "postfix", "prefix", "required", "static", "guard", "defer", "storage.type", "bool", "double", "Double", "extension", "float", "Float", "int", "Int", "open", "internal", "fileprivate", "private", "public", "string", "String", "constant.language", "false", "Infinity", "NaN", "nil", "no", "null", "off", "on", "super", "this", "true", "undefined", "yes", "support.function"
