...
public class JavaTextTokenizer {
    ...
    public static String[] CodeSpamel = {
            "forEach", "todo", "fixme", "tryCatch", "trycatchRes", "ifelse", "ifnotnull", "public_static_?", "public_static_String".trim()
    };
    ...
    protected static void doStaticInit() {
        sKeywords = new String[]{
                ...
                "this", "throw", "throws", "true", "false", "null", "var", "system", "out", "println", "format", "permits", "sealed"
        };
        Tokens[] sTokens = new Tokens[]{
                ...
                Tokens.THIS, Tokens.THROW, Tokens.THROWS, Tokens.TRUE, Tokens.FALSE, Tokens.NULL, Tokens.VAR, Tokens.SYSTEM, Tokens.OUT, Tokens.FORMAT, Tokens.PRINTLN, Tokens.PREMITS, Tokens.SEALED
        };
