...
public class JavaScriptParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements JavaScriptParserVisitor<T> {
     ...
     */
    @Override
    public T visitModuleItems(JavaScriptParser.ModuleItemsContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitComputedPropertyExpressionAssignment(JavaScriptParser.ComputedPropertyExpressionAssignmentContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitFunctionDecl(JavaScriptParser.FunctionDeclContext ctx) {
        return visitChildren(ctx);
    }
